...
window.addEventListener("DOMContentLoaded", () => {
  ...
  //   //n - это начальный индекс т.е. 1
  //   if (n > slides.length) {
  //     slideIndex = 1; // когда доходим до конца слайдов перемещаемся на 1
  //   }
  ...
  //   slides[slideIndex - 1].style.display = "block"; // - 1 чтобы показывать с 0 слайда
  ...
  //   showSlides((slideIndex += n)); //функция позволяющая показывать индекс(нумерацию) отображаемого слайда
  // }
